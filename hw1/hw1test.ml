...
let my_subset_test2 = subset ["a" ; "b"] ["a";"b";"c"];; 
...
let my_set_intersection_test1 = 
  equal_sets (set_intersection [4;4;4;4] [4;2]) [4] 
...
let my_set_diff_test1 = equal_sets (set_diff [1;2] [3;4]) [1;2]
...
type myNonterminals = 
| Eat | Exercise | Study | FinishProject

let myGrammarRules = 
  [Eat, [N Exercise; N Study];
   Exercise, [N Eat; T"Sleep"];
   Study, [N Eat; T"Sleep"; N Study];
   Eat, [N Eat];
   FinishProject, [T"Sleep"]]

let myGrammar = Eat, myGrammarRules
let my_filter_reachable_test0 = filter_reachable myGrammar = 
    (Eat,
       [Eat, [N Exercise; N Study];
        Exercise, [N Eat; T"Sleep"];
        Study, [N Eat; T"Sleep"; N Study];
